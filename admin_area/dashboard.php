...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header text-muted" style="font-style: italic; text-transform:uppercase">Dashboard</h1>
        ...
        <div class="panel">
            <div class="panel-body">
                <div class="mb-md thumb-info">
                    ...
                    <img src="../admin_worker_area/images/descarregar.jpg" width="100%" class="rounded img-responsive">

                    <div class="thumb-info-title">
                        <span class="thumb-info-inner">Gilberto Caetano</span>
                        <span class="thumb-info-type">Back-end Developer</span>
                    </div>
