<?php if (!isset($_SESSION['admin_email'])) {
    ...
    $edit_p_c_top=$p_cat_fetch['p_cat_top'];
    }
         }
    ?>
<div class="row">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                        <?php if ($edit_p_c_top=='yes') {
                            echo "<input type='radio' name='p_top' value='yes' checked>";
                        } else {
                            echo "<input type='radio' name='p_top' value='yes'";
                        }?>
                            <label for="">Yes</label>
                            <?php if ($edit_p_c_top=='no') {
                            echo "<input type='radio' name='p_top' value='no' checked>";
                        } else {
                            echo "<input type='radio' name='p_top' value='no'";
                        }?>
                            <label for=""> No</label>
                        </div>
                    </div>
