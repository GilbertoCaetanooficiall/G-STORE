...
<nav class="navbar navbar-in navbar-fixed-top">
    <div class="navbar-header">
        <button type="button" class="navbar-toggle" style="border-color: white;" data-toggle="collapse" data-target=".navbar-exl-collapse" >
            <span class="sr-only" style="background-color: white;">toggle navigation</span>
            <span class="icon-bar"style="background-color: white;"></span>
            <span class="icon-bar"style="background-color: white;"></span>
            <span class="icon-bar"style="background-color: white;"></span>
        </button>
        <a href="index.php?dashboard" class="navbar-brand cor"><i class="fa fa-shopping-cart"></i>  Admin Area</a>
    </div>
        ...
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                ...
                <ul id="coupon" class="collapse">
                    <li><a href="index.php?insert_coupon"> Inserir novos Coupons</a></li>
                    <li><a href="index.php?view_coupon"> Ver Coupons </a></li>
                </ul>
            </li>
            <li>
                ...
                <ul id="term" class="collapse">
                    <li><a href="index.php?insert_term"> Inserir novos regulamentos</a></li>
                    <li><a href="index.php?view_term"> Ver Regulamentos </a></li>
                </ul>
            </li>
            <li>
                <a href="index.php?view_customer">
            ...
            <li>
                ...
                <li><a href="index.php?view_user"> Ver usuários</a></li>
                    <li>
                    <a href="index.php?insert_user"> Inserir usuarios </a>
                    </li>
                     <li><a href="index.php?edit_profile=<?php echo $admin_id;?>"> Editar Perfil</a></li>
                </ul>
            </li>
            <li>
                    <a href="logout.php">
