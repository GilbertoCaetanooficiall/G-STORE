                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select name="product_cat" class="form-control" required>
                                <option selected disabled>Selecione a categoria de productos</option>
...
if (isset($_POST['insert'])) {
   ...
   $product_image=$_FILES['image_1']['tmp_name'];
    ...
    if (isset($_FILES['image_1']['name']) && isset($_FILES['image_2']['name']) && isset($_FILES['image_3']['name'])) {
       ...
       $sql2 ="INSERT INTO products SET 
         ...
         if($res2==true){
            ...
            echo "<script>alert('Falhou em adicionar um novo produto')</script>";
