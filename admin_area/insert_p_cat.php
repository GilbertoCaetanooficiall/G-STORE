            ...
            <div class="panel-body">
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="radio" name="p_top" value="yes">
                            <label for="">Yes</label>
                            <input type="radio" name="p_top" value="no">
                            <label for="">no</label>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="submit" value="inserir categoria de produtos" name="insert" class="btn btn-primary form-control">
                        </div>
                    </div>
                </form>
            </div>
