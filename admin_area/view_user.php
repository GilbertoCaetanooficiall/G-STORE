                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <?php 
                                  ...
                                  while ($fetch_admin=mysqli_fetch_assoc($run_admin)) {
                                    $admin_ida =$fetch_admin['admin_id'];
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($admin_id==$admin_ida) {?>
                                            <td><a href="index.php?edit_profile=<?php echo $admin_id;?>"><i class="fa fa-pencil"> Editar</i></a></td>
                                      ...
                                      <?php    } else { ?>
                                            <td><a href="index.php?edit_admin=<?php echo $admin_ida;?>"><i class="fa fa-pencil"> Editar</i></a></td>
                                            <td><a href="index.php?delete_admin=<?php echo $admin_ida. "&image1=".$admin_image;?>" style="color: red; text-decoration: none;"><i class="fa fa-trash-o"> Apagar</i></a></td>
